 ...
 * 
 * DecimalDialog class
 * Convert a decimal number to binary, octal, and hexadecimal number
 *
 */
...
public class DecimalDialog extends JInternalFrame{
	private static DecimalDialog instance = null;
	...
	public static DecimalDialog getInstance(){
		if(instance == null){
			instance = new DecimalDialog();
		}
		return instance;
	}
	...
	private DecimalDialog(){
		...
		super("Decimal", false, true, false, false);
	...
	private void Decimal(){
		...
		try{
			...
			ConvertDecimal conDec = new ConvertDecimal(dec);
			label1.setText("Binary: " + conDec.getBinary());
			label2.setText("Octal: " + conDec.getOctal());
			label3.setText("Hexadecimal: " + conDec.getHexa());
		}
